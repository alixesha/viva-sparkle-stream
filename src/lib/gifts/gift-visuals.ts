...
export const SCENES: Record<string, Scene> = {
  ...
  lion: {
    ...
    hero: "cine-charge",
    heroSize: 74,
    backdrop: "radial-gradient(circle at 50% 55%, rgba(255,185,60,.18), rgba(20,8,0,.5) 60%, rgba(0,0,0,.75))",
    dim: 0.92,
    rays: [],
    flashes: [{ at: 6300, color: "rgba(255,220,140,.5)", dur: 480 }],
    shake: [{ at: 6320, strength: 16, dur: 900 }],
    emitters: [
      { kind: "ring", at: 6320, count: 3, colors: ["#ffd76a", "#ff9d2e"], origin: "center", life: 1300, stagger: 170 },
      { kind: "confetti", at: 6400, count: 70, colors: GOLD, origin: "center", size: 10, speed: 640, life: 2400, gravity: 320 },
      { kind: "ember", at: 7000, count: 46, colors: GOLD, origin: "bottom", size: 8, speed: 300, life: 2400, gravity: -120 },
    ],
  },
  dragon: {
    tier: "legendary",
